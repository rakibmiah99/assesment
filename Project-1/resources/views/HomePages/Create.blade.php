    ...
    <div class="container-sm mt-5">
        <div class="card">
            <div class="d-flex card-header justify-content-between align-items-center">
                <h5 class="m-0">To-Do List Create</h5>
                ...
                <div class="card-body">
                    <form method="post" action="{{route('home.create')}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('date')}}" type="date" name="date" class="form-control" id="basic-default-date">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-title">Title (*)<span class="text-danger ms-4">@error('title') {{$message}}  @enderror</span></label>
                            <input type="text" value="{{old('title')}}" name="title" class="form-control" id="basic-default-title" placeholder="Meeting with orrangetoolz">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-description">Description</label>
                            <textarea name="description" value="{{old('description')}}" rows="6" id="basic-default-description" class="form-control" placeholder="type here for something details...."></textarea>
                        </div>
